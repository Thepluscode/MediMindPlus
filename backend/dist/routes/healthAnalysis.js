...
const HealthAnalysisController_1 = require("../controllers/HealthAnalysisController");
const authorization_1 = require("../middleware/authorization");
const router = (0, express_1.Router)();
const controller = new HealthAnalysisController_1.HealthAnalysisController();
 ...
 */
router.post('/voice/analyze', HealthAnalysisController_1.uploadAudio, controller.analyzeVoice);
/**
 ...
 * @access Authenticated users
 */
router.post('/camera/analyze', HealthAnalysisController_1.uploadFrames, controller.analyzeCameraFrames);
/**
