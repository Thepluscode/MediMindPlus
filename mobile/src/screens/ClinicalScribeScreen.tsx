    ...
    <View style={styles.container}>
      <LinearGradient colors={theme.gradients.primary.colors} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Typography variant="body" style={styles.headerTitle}>AI Clinical Scribe</Typography>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.recordingSection}>
          <Typography variant="body" style={styles.sectionTitle}>Voice Recording</Typography>

          {/* Timer */}
          <Typography variant="body" style={styles.timer}>{formatDuration(recordingDuration)}</Typography>
          ...
          {isProcessing && (
            <View style={styles.processingContainer}>
              ...
              <Typography variant="body" style={styles.processingText}>Processing audio...</Typography>
            </View>
          )}
        </View>
        ...
        {transcription && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <Typography variant="body" style={styles.sectionTitleSmall}>Transcription</Typography>
            </View>
            <View style={styles.card}>
              <Typography variant="body" style={styles.transcriptionText}>{transcription}</Typography>
            </View>
          </View>
        )}
        ...
        {soapNote && (
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              ...
              <Typography variant="body" style={styles.sectionTitleSmall}>SOAP Note</Typography>
            </View>

            {/* Subjective */}
            <View style={styles.card}>
              <Typography variant="body" style={styles.soapSectionTitle}>Subjective</Typography>
              <View style={styles.soapContent}>
                <Typography variant="body" style={styles.soapLabel}>Chief Complaint:</Typography>
                <Typography variant="body" style={styles.soapText}>{soapNote.subjective.chiefComplaint}</Typography>

                <Typography variant="body" style={styles.soapLabel}>History of Present Illness:</Typography>
                <Typography variant="body" style={styles.soapText}>{soapNote.subjective.historyOfPresentIllness}</Typography>

                {soapNote.subjective.medications && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Medications:</Typography>
                    {soapNote.subjective.medications.map((med, i) => (
                      <Typography variant="body" key={i} style={styles.soapListItem}>• {med}</Typography>
                    ))}
                  </>
                )}
                ...
                {soapNote.subjective.allergies && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Allergies:</Typography>
                    {soapNote.subjective.allergies.map((allergy, i) => (
                      <Typography variant="body" key={i} style={styles.soapListItem}>• {allergy}</Typography>
                    ))}
                  </>
                )}
              </View>
            ...
            {/* Objective */}
            <View style={styles.card}>
              <Typography variant="body" style={styles.soapSectionTitle}>Objective</Typography>
              <View style={styles.soapContent}>
                {soapNote.objective.vitalSigns && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Vital Signs:</Typography>
                    <View style={styles.vitalsGrid}>
                      <View style={styles.vitalItem}>
                        <Typography variant="body" style={styles.vitalLabel}>BP</Typography>
                        <Typography variant="body" style={styles.vitalValue}>{soapNote.objective.vitalSigns.bloodPressure}</Typography>
                      </View>
                      <View style={styles.vitalItem}>
                        <Typography variant="body" style={styles.vitalLabel}>HR</Typography>
                        <Typography variant="body" style={styles.vitalValue}>{soapNote.objective.vitalSigns.heartRate}</Typography>
                      </View>
                      <View style={styles.vitalItem}>
                        <Typography variant="body" style={styles.vitalLabel}>RR</Typography>
                        <Typography variant="body" style={styles.vitalValue}>{soapNote.objective.vitalSigns.respiratoryRate}</Typography>
                      </View>
                      <View style={styles.vitalItem}>
                        <Typography variant="body" style={styles.vitalLabel}>Temp</Typography>
                        <Typography variant="body" style={styles.vitalValue}>{soapNote.objective.vitalSigns.temperature}°F</Typography>
                      </View>
                    </View>
                  </>
                )}

                <Typography variant="body" style={styles.soapLabel}>Physical Exam:</Typography>
                {soapNote.objective.physicalExam.map((finding, i) => (
                  <Typography variant="body" key={i} style={styles.soapListItem}>• {finding}</Typography>
                ))}
              </View>
            </View>
            ...
            {/* Assessment */}
            <View style={styles.card}>
              <Typography variant="body" style={styles.soapSectionTitle}>Assessment</Typography>
              <View style={styles.soapContent}>
                <Typography variant="body" style={styles.soapLabel}>Diagnoses:</Typography>
                {soapNote.assessment.diagnoses.map((diagnosis, i) => (
                  <View key={i} style={styles.diagnosisItem}>
                    <Typography variant="body" style={styles.diagnosisText}>
                      {i + 1}. {diagnosis.condition}
                    </Typography>
                    {diagnosis.icd10 && (
                      <View style={styles.codeChip}>
                        <Typography variant="body" style={styles.codeText}>ICD-10: {diagnosis.icd10}</Typography>
                      </View>
                    )}
                  </View>
                ))}
                ...
                {soapNote.assessment.clinicalReasoning && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Clinical Reasoning:</Typography>
                    <Typography variant="body" style={styles.soapText}>{soapNote.assessment.clinicalReasoning}</Typography>
                  </>
                )}
              </View>
            </View>
            ...
            {/* Plan */}
            <View style={styles.card}>
              <Typography variant="body" style={styles.soapSectionTitle}>Plan</Typography>
              <View style={styles.soapContent}>
                {soapNote.plan.medications && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Medications:</Typography>
                    {soapNote.plan.medications.map((med, i) => (
                      <Typography variant="body" key={i} style={styles.soapListItem}>
                ...
                {soapNote.plan.procedures && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Procedures:</Typography>
                    {soapNote.plan.procedures.map((proc, i) => (
                      <View key={i} style={styles.diagnosisItem}>
                        <Typography variant="body" style={styles.soapListItem}>• {proc.procedure}</Typography>
                        {proc.cpt && (
                          <View style={styles.codeChip}>
                            <Typography variant="body" style={styles.codeText}>CPT: {proc.cpt}</Typography>
                          </View>
                        )}
                      </View>
                    ))}
                ...
                {soapNote.plan.patientEducation && (
                  <>
                    <Typography variant="body" style={styles.soapLabel}>Patient Education:</Typography>
                    {soapNote.plan.patientEducation.map((edu, i) => (
                      <Typography variant="body" key={i} style={styles.soapListItem}>• {edu}</Typography>
                    ))}
                  </>
                )}
              </View>
            ...
            <View style={styles.actionButtons}>
              <TouchableOpacity style={styles.secondaryButton} onPress={saveNote}>
                ...
                <Typography variant="body" style={styles.secondaryButtonText}>Save Draft</Typography>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.primaryButton} onPress={signOffNote}>
                ...
                >
                  ...
                  <Typography variant="body" style={styles.primaryButtonText}>Sign Off</Typography>
                </LinearGradient>
              </TouchableOpacity>
            </View>
          </View>
    ...
    <View style={styles.container}>
      <LinearGradient colors={theme.gradients.primary.colors} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Typography variant="body" style={styles.headerTitle}>Recent Notes</Typography>
          <View style={{ width: 24 }} />
        </View>
      </LinearGradient>
        ...
        {recentNotes.map(note => (
          ...
          >
            <View style={styles.noteHeader}>
              <Typography variant="body" style={styles.noteType}>{note.noteType.replace('_', ' ').toUpperCase()}</Typography>
              <Typography variant="body" style={styles.noteDate}>
                {new Date(note.createdAt).toLocaleDateString()}
              </Typography>
            </View>
            <Typography variant="body" style={styles.notePreview} numberOfLines={2}>
              {note.transcription.fullText}
            </Typography>
            <View style={styles.noteFooter}>
              <View style={styles.noteStats}>
                <Ionicons name="time" size={14} color="#64748b" />
                <Typography variant="body" style={styles.noteStatText}>
