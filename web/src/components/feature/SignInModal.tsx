...
export default function SignInModal({ isOpen, onClose, defaultMode = 'signin' }: SignInModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[99999] overflow-y-auto bg-black/50 backdrop-blur-sm animate-fadeIn" onClick={onClose}>
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden animate-slideUp" onClick={(e) => e.stopPropagation()}>
          {/* Close Button */}
          <button
            onClick={onClose}
